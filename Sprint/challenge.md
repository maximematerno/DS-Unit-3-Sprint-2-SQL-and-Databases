...
Employee is connected to Territory by an intermediary table called EmployeeTerritory,  I would classify the relationship as one-to-many.


- What is a situation where a document store (like MongoDB) is appropriate, and
  what is a situation where it is not appropriate?

A situation where a document store (like MongoDB) is appropriate:
...
A situation where a document store (like MongoDB) is not appropriate:
...
NewSQL is a class of relational database management systems that provide the scalability of NoSQL systems. 
NewSQL systems attempt to reconcile the conflicts. Trying to solve what SQL and NoSQL can't on their own.
